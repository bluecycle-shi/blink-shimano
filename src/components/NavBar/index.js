        ...
        <div className="row">
          <ul className="list-unstyled mb-0">
            <li className="nav-item">
              ...
              {createElement(
                'a',
                { href: '/fornecedores', className: 'nav-link' },
                'Fornecedores',
              )}
            </li>
            <li className="nav-item">
            ...
            <li className="nav-item">
              ...
              {createElement(
                'a',
                { href: '/destaque/promocao', className: 'nav-link' },
                'Ofertas do mês',
              )}
            </li>
            <li className="nav-item">
              ...
              {createElement(
                'a',
                { href: '/destaque/lancamento', className: 'nav-link' },
                <TituloLancamento />,
              )}
              {/* <span className="badge badge-laranja">!</span> */}
            </li>
            <li className="nav-item">
              ...
              {createElement(
                'a',
                { href: '/destaque/revista', className: 'nav-link' },
                'Itens mais vendidos',
              )}
            </li>
            {/* <li className="nav-item">
            ...
            <li className="nav-item">
              ...
              {createElement(
                'a',
                { href: '/destaque/marcapropria', className: 'nav-link' },
                'Marca Própria',
              )}
            </li>
          </ul>
